// Fonction pour convertir une distance métrique à une distance impériale.
exports.unitsMetricToImperial = function(data){
    ...
    if (valuesUnits.length == unitsMetricsLength) {
    ...
    if (typeof(resultInCm) != 'string') {
        ...
        return units + " donne " + imperialDistance + " en unités impériales";
    } else {
...
// Fonction pour convertir une distance impériale à une distance métrique.
exports.unitsImperialToMetric = function(data){
    ...
    if (valuesUnits.length == unitsImperialLength) {
    ...
    if (typeof(resultInInch) != 'string') {
        ...
        return units + " donne " + metricDistance + " en unités métriques";
